 ...
 */
public class CourseTypeCond extends BaseCondition {
    ...
    public void addCondition() {
        ...
        add(branchName, "AND T.branch_name LIKE ?", 3);
        add(keepPro, "AND T.keep_pro = ?");
        add(keepProName, "AND T.keep_pro_name LIKE ?", 3);
        add(courseCategory, "AND T.course_category = ?");
        add(courseCategoryName, "AND T.course_category_name LIKE ?", 3);
        add(chargeMode, "AND T.charge_mode = ?");
        add(days, "AND T.days = ?");
        add(price, "AND T.price = ?");
        add(count, "AND T.count = ?");
        add(timeLength, "AND T.time_length = ?");
        add(onSale, "AND T.on_sale = ?");
        add(imgPath, "AND T.img_path LIKE ?", 3);
        add(courseTypeDescribe, "AND T.course_type_describe LIKE ?", 3);
        add(color, "AND T.color LIKE ?", 3);
        add(isCommon, "AND T.is_common = ?");
